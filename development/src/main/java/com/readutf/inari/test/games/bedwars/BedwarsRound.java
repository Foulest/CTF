...
public class BedwarsRound implements Round {
    ...
    BedwarsRound(@NotNull Game game) {
        this.game = game;
        logger = game.getLoggerFactory().getLogger(getClass());
        generatorManager = new GeneratorManager(game);
        bedToTeam = new HashMap<>();
    ...
    Team getTeamFromBedPosition(Location location) {
    ...
    void destroyBed(Player destroyer, BedwarsTeam team) {
